...
public class File__1 {
    ...
    @JsonProperty("resolution")
    public void setResolution(Resolution__1 resolution) {
    ...
    public String toString() {
        ...
        sb.append(File__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
